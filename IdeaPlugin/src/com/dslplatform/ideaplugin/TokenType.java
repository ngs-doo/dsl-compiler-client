...
public class TokenType extends IElementType {
	...
	public static final TextAttributesKey IDENTIFIER_KEY = createTextAttributesKey("IDENTIFIER", DefaultLanguageHighlighterColors.IDENTIFIER);
	...
	public static final TokenType KEYWORD = new TokenType(SyntaxType.Keyword.name(), new TextAttributesKey[]{KEYWORD_KEY});
	public static final TokenType IDENTIFIER = new TokenType(SyntaxType.Identifier.name(), new TextAttributesKey[]{IDENTIFIER_KEY});
	public static final TokenType STRING_QUOTE = new TokenType(SyntaxType.StringQuote.name(), new TextAttributesKey[]{STRING_KEY});
	...
	public static TokenType from(SyntaxType type) {
		switch (type) {
			case Keyword:
				return KEYWORD;
			case Identifier:
