...
public class TemplateDeleteProcessor implements MockProcessor {
    @Override
    public boolean isDefinedAt(final HttpRequest request) {
        return request.method == Method.POST && request.path.startsWith("Domain.svc/submit/Client.DeleteTemplate");
    }
