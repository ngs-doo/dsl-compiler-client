...
public class MockData {
    ...
    public static final String test_migration_sql_simple_old = resourceToString("/test_migration_sql_simple/old.dsl");
    public static final String test_migration_sql_simple_new = resourceToString("/test_migration_sql_simple/new.dsl");
    public static final Map<String, String> dsl_test_migration_single_old = new HashMap<String, String>() {{put("test.dsl",
            test_migration_sql_simple_old);}};
    public static final Map<String, String> dsl_test_migration_single_new = new HashMap<String, String>() {{put("test.dsl",
            test_migration_sql_simple_new);}};
    public static final String test_migration_sql_bad = resourceToString("/test_migration_sql_simple/bad.dsl");
    public static final String test_migration_sql_response = resourceToString(
            "/test_migration_sql_simple/SQLMigration.response");
    public static final String test_migration_serversource_response = resourceToString(
            "/test_migration_sql_simple/ServerSource.response");
    public static final Migration migration_test_migration_single = new Migration(3, version_real, dsl_test_migration_single_old);
