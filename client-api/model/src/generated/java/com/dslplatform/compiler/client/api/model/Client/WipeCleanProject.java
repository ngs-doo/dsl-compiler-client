...
public final class WipeCleanProject implements DomainEvent,
        java.io.Serializable {
    public WipeCleanProject(
    ...
    public boolean equals(final Object obj) {
        ...
        final WipeCleanProject other = (WipeCleanProject) obj;
    ...
    public String toString() {
        return URI != null
                ? "WipeCleanProject(" + URI + ')'
                : "new WipeCleanProject(" + super.hashCode() + ')';
    }
    ...
    public WipeCleanProject setProject(final String value) {
        if (value == null)
