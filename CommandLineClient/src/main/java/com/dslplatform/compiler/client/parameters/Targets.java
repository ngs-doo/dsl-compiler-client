...
public enum Targets implements CompileParameter, ParameterParser {
	...
	public enum Option {
		REVENJ_JAVA("revenj.java", "Revenj.Java server for Postgres", ".java", new CompileRevenjJava("revenj.java", "revenj-java", "revenj-servlet"), true),
		REVENJ_JAVA_POSTGRES("java_server_postgres", "Revenj.Java server for Postgres", ".java", new CompileRevenjJava("java_server_postgres", "revenj-java", "revenj-servlet"), true),
		...
		SCALA_SERVER_ORACLE("scala_server_oracle", "Scala server (Oracle)", ".scala", new CompileScalaClient("Scala server (Oracle)", "scala-poso", "scala_server_oracle", null, "./generated-scala-oracle.jar"), false);
	...
	public boolean check(final Context context) throws ExitException {
		...
		final boolean sourceOnly = Settings.get(context).contains(Settings.Option.SOURCE_ONLY);
		if (!sourceOnly) {
	...
	private void compile(Context context, List<Option> targets) throws ExitException {
		...
		final boolean sourceOnly = settings.contains(Settings.Option.SOURCE_ONLY);
